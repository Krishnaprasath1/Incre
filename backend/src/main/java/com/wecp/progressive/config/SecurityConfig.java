...
public class SecurityConfig extends WebSecurityConfigurerAdapter 
{
    ...
    @Autowired
    public SecurityConfig(UserLoginServiceImpl userLoginServiceImpl, JwtRequestFilter jwtRequestFilter,
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
               ...
               // .antMatchers(HttpMethod.POST, "/vote", "/team/**", "/cricketer/", "/match").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.POST,"/vote").hasAuthority("ADMIN")
    ...
    // @Bean // I am getting error . Check Why I am getting error. Reason I think is duplicate Bean
