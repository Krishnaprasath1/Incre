...
public class MatchServiceImplJpa implements MatchService {
    ...
    public Integer addMatch(Match match) throws SQLException {
        match.setFirstTeam(this.teamRepository.findByTeamId(match.getFirstTeam().getTeamId()));
        match.setSecondTeam(this.teamRepository.findByTeamId(match.getSecondTeam().getTeamId()));
       // match.setWinnerTeam(this.teamRepository.findByTeamId(match.getWinnerTeam().getTeamId()));
