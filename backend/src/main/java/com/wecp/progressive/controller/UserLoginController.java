...
public class UserLoginController 
{
    ...
    public ResponseEntity<?> handleRuntimeException(RuntimeException rtEx)
    {   
    ...
    public ResponseEntity<?> loginUser(@RequestBody LoginRequest loginRequest)  throws Exception
    {
        ...
        final String roles = user.getRole();
        final Integer userId = user.getUserId();

        return ResponseEntity.ok(new LoginResponse(token, roles, userId));
    }
}
