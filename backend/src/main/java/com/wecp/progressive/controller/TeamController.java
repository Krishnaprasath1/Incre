...
public class TeamController {
    ...
    public ResponseEntity<?> handleTeamDoesNotExistException(TeamDoesNotExistException tdneEx)
    {
        return new ResponseEntity<>(HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(TeamAlreadyExistsException.class)
    public ResponseEntity<?> handleTeamAlreadyExistsException(TeamAlreadyExistsException taeEx)
    {
   ...
   // @Autowired we should not key autowired to arrayList because it is not related to JPA
